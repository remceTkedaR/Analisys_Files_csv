...
header_ask = (get_dates_header("Pytanie_13_1.csv"))
print(header_ask)
# Grupa 1
...
def question_grup(question_number, nb_qustion, grupa_nb, header=[]):
    ...
    file_out = []
    b = nb_qustion
    filename = str('number13_' + str(b) + ' _Grupa- ' + grupa_nb + '.csv')
...
get_dates_answer_grup_1('Pytanie_13_1.csv', header_ask, grupa_1)
...
# -------- Grupa 2
get_dates_answer_grup_2('Pytanie_13_1.csv', header_ask, grupa_2)
...
# -------- Grupa 3
get_dates_answer_grup_3('Pytanie_13_1.csv', header_ask, grupa_3)
