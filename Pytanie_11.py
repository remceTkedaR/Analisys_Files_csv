...
header_ask = (get_dates_header("Pytanie_14_1.csv"))
...
def question_grup(question_number, nb_qustion, grupa_nb, header=[]):
    ...
    file_out = []
    b = nb_qustion
    filename = str('number14_' + str(b) + ' _Grupa- ' + grupa_nb + '.csv')
...
get_dates_answer_grup_1('Pytanie_14_1.csv', header_ask, grupa_1)
...
# -------- Grupa 2
get_dates_answer_grup_2('Pytanie_14_1.csv', header_ask, grupa_2)
...
# -------- Grupa 3
get_dates_answer_grup_3('Pytanie_14_1.csv', header_ask, grupa_3)
